...
void ConsoleManager::createProcess(string name, uint16_t memorySize)
{

	shared_ptr<Console> newConsole = this->scheduler->generateRandomProcess(name, false, memorySize);
